            ...
            <div class="col-sm-6 top-header-sub">
                <div class="breadcrumbs-area clearfix">
                    <div class="breadcrumbs-sub">
                        ...
                        <h4 class="page-title pull-left proxima_nova_semibold">Upcoming Leaves Request
                        </h4>
                    </div>
                    <ul class="breadcrumbs pull-left">
                        <li class="section_sub_title"><a href="{{route('dashboard')}}">Dashboard</a></li>
                        <li class="section_sub_title">/  Attendance</li>
                        <li class="section_sub_title">/  Upcoming Leaves Request</li>
                    </ul>
                </div>
            </div>
        </div>
...
@endsection
@section('content')
    <div class="atten-daily-work">
        <row>
            <div class="approve-datas">
                <div class="approve-data-search col-md-6 col-sm-6">
                    <div class="upcoming-date">
                        <h1 class="proxima_nova_semibold section_title ">Leave Log</h1>
                        <p>06 Sep, 2023 - 12 Sep, 2023</p>
                    </div>
                </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="approve-main-sec"><button
                            ...
                            <button class="atten-coming-btn"><svg xmlns="http://www.w3.org/2000/svg"
