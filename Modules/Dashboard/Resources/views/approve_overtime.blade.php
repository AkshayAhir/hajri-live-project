...
@section('title')
<title>{{env('APP_NAME')}} | Approve Overtime</title>
@endsection
@section('header-page')
        ...
        <div class="col-sm-6 top-header-sub">
            <div class="breadcrumbs-area clearfix">
                <div class="breadcrumbs-sub">
                    <a href="{{route('dashboard')}}"><img src="{{asset('assets/admin/images/header/back.svg')}}"
                            alt=""></a>
...
<div class="shifts-data">
    <div class="filters sidebar-select approve-punch-data">
        <select id="main_select_services" class="form-select create-select section_sub_title select-club-services"
            name="club-services">
    ...
    <div class="approve-datas approve_punches">
        ...
        <div class="approve-right-data col-md-6 col-sm-6">
            ...
            <div class="input-group date" data-provide="datepicker">
                <input type="text"
                    class="form-control proxima_nova_semibold calender-picker input-group-addon calender-img"
                    readonly='true'>
    ...
    <table id="staff_datas" class="display" style="width:100%">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="overtime-salary-section">
                        <!-- <select name="select-salarry" id="select-salarry">
                            ...
                            <option value="Salary"><a href="">Add Custom Salary Multiple</a></option>
                        </select> -->
                        <div class="filters sidebar-select approve-salary">
                            <select id="main_select_services"
                                class="form-select create-select section_sub_title  select-salary-data"
                                name="club-services">
                                <option value=".abrikosovaya" >Fixed Amount</option>
                                <option value=".bratskaya">1x Salary</option>
                                <option value=".lesi-ukrainki" selected>1.5x Salary</option>
                                <option value=".lesi-ukrainki">2x Salary</option>
                                <option value="Salary"><a href="">Add Custom Salary Multiple</a></option>
                            </select>
                        </div>
            ...
            <tr>
                ...
                <td>9:05</td>
                <td>6:01</td>
                <td class="over_time">20 Mins</td>
                <td>
                    <div class="overtime-salary-section">
                        <!-- <select name="select-salarYry" id="select-salary">
                            <option value="">Fixed Amount</option>
                            <option value="Salary" selected>1x Salary</option>
                            <option value="Salary">1.5x Salary</option>
                            <option value="Salary">2x Salary</option>
                        ...
                        <div class="filters sidebar-select approve-salary">
                            <select id="main_select_services"
                                class="form-select create-select section_sub_title  select-salary-data"
                                name="club-services">
                                <option value=".abrikosovaya" selected>Fixed Amount</option>
                                <option value=".bratskaya">1x Salary</option>
                                <option value=".lesi-ukrainki" selected>1.5x Salary</option>
                                <option value=".lesi-ukrainki">2x Salary</option>
                                <option value="Salary"><a href="">Add Custom Salary Multiple</a></option>
            ...
            <tr>
                ...
                <td>9:00</td>
                <td>9:01</td>
                <td class="over_time">49 Mins</td>
                <td>
                    <div class="overtime-salary-section">
                        <!-- <select name="select-salarYry" id="select-salary">
                            <option value="">Fixed Amount</option>
                            <option value="Salary">1x Salary</option>
                            <option value="Salary">1.5x Salary</option>
                            <option value="Salary">2x Salary</option>
                            <option value="Salary">Add Custom Salary Multiple</option>
                        </select> -->
                        <div class="filters sidebar-select approve-salary">
                            <select id="main_select_services"
                                ...
                                <option value=".abrikosovaya">Fixed Amount</option>
                                <option value=".bratskaya">1x Salary</option>
                                <option value=".lesi-ukrainki">1.5x Salary</option>
                                <option value=".lesi-ukrainki" selected>2x Salary</option>
                                <option value="Salary"><a href="">Add Custom Salary Multiple</a></option>
                            </select>
                        </div>
                    </div>
                ...
                <td>
                    ...
                    <div class="filters sidebar-select approve-salary">
                            <select id="main_select_services"
                                ...
                                name="club-services">
                                <option value=".abrikosovaya" >Fixed Amount</option>
                                <option value=".bratskaya" selected>1x Salary</option>
                                <option value=".lesi-ukrainki">1.5x Salary</option>
                                <option value=".lesi-ukrainki">2x Salary</option>
                                <option value="Salary"><a href="">Add Custom Salary Multiple</a></option>
                            </select>
...
<script>
    ...
    $('select.select-salary-data').each(function () {

        var dropdown = $('<div />').addClass('select-salary-data selectDropdown');
    ...
    $('.select-salary-data > span').on('click touch', function (e) {
