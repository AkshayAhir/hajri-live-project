...
@section('title')
    <title>{{env('APP_NAME')}} | Detailed Attendance View</title>
@endsection
@section('header-page')
            ...
            <div class="col-sm-6 top-header-sub">
                <div class="breadcrumbs-area clearfix">
                    <div class="breadcrumbs-sub">
                        ...
                        <h4 class="page-title pull-left proxima_nova_semibold">Detailed Attendance View
                        </h4>
                    </div>
                    <ul class="breadcrumbs pull-left">
                        <li class="section_sub_title"><a href="{{route('dashboard')}}">Dashboard</a></li>
                        <li class="section_sub_title">/  Attendance</li>
                        <li class="section_sub_title">/  Detailed Attendance View</li>
                    </ul>
                </div>
            </div>
        </div>
...
@endsection
@section('content')
    <div class="detail-atten-view">
        <div class="">
            <ul class="nav nav-tabs" id="myTabs">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active proxima_nova_semibold" id="month-tab" data-bs-toggle="tab" href="#month" role="tab" aria-controls="month" aria-selected="true">Monthly Attendance</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link proxima_nova_semibold" id="daily-tab" data-bs-toggle="tab" href="#daily" role="tab" aria-controls="daily" aria-selected="false">Daily Attendance</a>
                </li>
            </ul>
        </div>
        <row>
            <div class="approve-datas">
                <div class="approve-data-search month-daily-atten-main col-md-6 col-sm-6">
                    <form action="" method="">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="month" role="tabpanel" aria-labelledby="month-tab">
                <div class="approve_staff_data" id="monthly_attendance">
                    <table id="staff_datas" class="display" style="width:100%">
                        ...
                        <tbody>
                        <tr>
                            <td><input type="checkbox" class="selectCheckbox_model" id="selectCheckbox_model">
                            </td>
                            <td>
                                <div class="user-images">
                                    <div><img src="{{asset('assets/admin/images/approve_punches/ic-user.svg')}}" class="approve-user-img" alt=""></div>
                            ...
                            <td>40 Mins</td>
                            <td>
                                <div class="total_atten">
                                    <p class="proxima_nova_semibold">18P</p>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="total_atten">
                                    <p class="proxima_nova_semibold">10P</p>
                                </div>
                            </td>
                        </tr>

                        <tr>
                            <td><input type="checkbox" class="selectCheckbox_model"
                                       id="selectCheckbox_model">
                            </td>
                            <td>
                                <div class="user-images">
                                    <div><img src="{{asset('assets/admin/images/approve_punches/user.svg')}}"
                            ...
                            <td>
                                <div class="total_atten">
                                    <p class="proxima_nova_semibold">5P</p>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="user-images">
                                    <div><img src="{{asset('assets/admin/images/approve_punches/user.svg')}}"
                                              class="approve-user-img" alt=""></div>
                                    <div>Nihal Desai<p class="data-sub-field">Project Manager</p>
                                    </div>
                                </div>
                            </td>
                            <td>15</td>
            ...
            <div class="tab-pane fade" id="daily" role="tabpanel" aria-labelledby="daily-tab">
                <div class="approve_staff_data" id="daily_attendance menu1">
                    <table id="daily_data" class="display" style="width:100%">
                        <thead>
                        <tr>
                            <th><input type="checkbox" id="selectAllCheckbox"></th> <!-- Checkbox Column -->
                            <th>Staff Name</th>
        ...
        <div id="myModal" class="modal check-model">
            <div class="model-section">
                <div class="model_left_side">
                    <div class="selected_check_member proxima_nova_semibold">1</div>
                </div>
                <div class="model_right_side">
                    <div class="member_div proxima_nova_semibold">Members Selected
                    </div>
                    <div class="export_div">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="2.25" y="2.25" width="13.5" height="13.5" rx="2" stroke="#808080" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M6.75 2.25V15.75" stroke="#808080" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M15.75 6.75H6.75" stroke="#808080" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M15.75 11.25H6.75" stroke="#808080" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
...
@section('scripts')
    <script>
        ...
        $(document).ready(function () {
            var table = $('#daily_data').DataTable({
                searching: false,
                lengthChange: false,
                info: false,
            });
