...
@section('title')
    <title>{{env('APP_NAME')}} | Absent</title>
@endsection
@section('header-page')
            ...
            <div class="col-sm-6 top-header-sub">
                <div class="breadcrumbs-area clearfix">
                    <div class="breadcrumbs-sub">
                        ...
                        <h4 class="page-title pull-left proxima_nova_semibold">Absent
                        </h4>
                    </div>
                    <ul class="breadcrumbs pull-left">
                        <li class="section_sub_title"><a href="{{route('dashboard')}}">Dashboard</a></li>
                        <li class="section_sub_title">/  Absent</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                table = $('#staff_datas').DataTable({
                    ...
                    initComplete: function(settings, json) {
                        ...
                        if (table.rows().count() === 0) {
                            ...
                            var adContent = '<tr><td colspan="7"><div class="no_data_found"><div class=""><img src="{{asset('assets/admin/images/staff_manage/no_data.svg')}}" alt="Advertisement"></div><div class="proxima_nova_semibold section_title">No data found, absent</div></div></td></tr>';
