            ...
            <div class="col-sm-6 top-header-sub">
                <div class="breadcrumbs-area clearfix">
                    <div class="breadcrumbs-sub">
                        ...
                        <h4 class="page-title pull-left proxima_nova_semibold">Leave management
                        </h4>
                    </div>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="dashboard.html">Attendance</a></li>
                        <li class="section_sub_title">/  Leave management</li>
                    </ul>
                </div>
            </div>
        </div>
...
@section('content')
    ...
    <div class="main-content-inner">
        ...
        <div class="shifts-data review-approve-time">
            ...
            <div>
                <a href="" class="over_time proxima_nova_semibold overtime-approve">Bulk Approve Leave management</a>
            </div>
        </div>
            ...
            <table id="staff_datas" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Due to family trip planing.</td>
                        <td>
                            <div class="approve-main-sec">
                                <button class="atten-coming-btn approve_success"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
