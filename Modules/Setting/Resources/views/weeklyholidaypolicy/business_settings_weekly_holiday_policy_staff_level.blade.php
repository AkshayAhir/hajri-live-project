...
=======
                <div class="holiday-days">
                    ...
                    <div class="holiday-datastaff row">
                        <div class="holidayexpand section_sub_title col-md-4" data-bs-toggle="collapse" data-bs-target="#sundaydropdown" aria-expanded="false" aria-controls="sundaydropdown">
...
=======
                        <div class="col-md-4 text-center">
                            <p class="business-manager-count">Not Assigned</p>
                        </div>
...
=======
                            Deep Patel, Piyush Kheni, Harsh Sanghavi, Nihal Desai and 
                            <a href="" class="more-data">10+ more.</a>
                        </div>
                    </div>


                    <div class="holiday-datastaff row">
                        <div class="holidayexpand section_sub_title col-md-4" data-bs-toggle="collapse"
>>>>>>> 9ee7d98de403d43c1e001aefae0ecaf8228cb55b
...
=======
    <script>
        ...
        $('.business-level').on("click", function(){
            window.location.href = "{{ url('setting/weekly_holiday_policy_business_level') }}";
        });
        $('.continue_btn').on("click", function(){
