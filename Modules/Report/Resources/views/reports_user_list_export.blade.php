            ...
            <div class="breadcrumbs-area clearfix">
                <div class="breadcrumbs-sub">
                    ...
                    <a class="back_button"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <h4 class="page-title pull-left proxima_nova_semibold">User List export
                        </h4>
                    </div>
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li class="section_sub_title">/ User List export</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="main-content-inner on-time-main main-atten report_user_list_export">

    <row>
        <div class="approve-datas atten-datas report-main-list attendance_reports_table_top">
            <div class="atten-data-search assign-data-search report_data col-md-6">
            ...
            <div class="approve-right-data report-user-list-data col-md-6">

                <div class="approve-data-download  dropdown-toggle proxima_nova_bold report_user_list_download_data report_data_download">
                ...
                <!-- <div class="dropdown-menu" x-placement="bottom-start">
                    <a class="dropdown-item proxima_nova_semibold" href="#" id="user_export">Excel Report</a>
                ...
                <!-- <div class="input-group date" data-provide="datepicker">
                        <input type="text" id="calender_date" class="form-control input-group-addon proxima_nova_semibold calender-picker" readonly="true">
    ...
    <div class="approve_staff_data user_list_table">
    ...
    <!-- <div class="assign-edit-btn">
            <button name="" id="apply_staff" class="save-staff-btn proxima_nova_semibold">Apply</button>
        </div> -->
...
<script>
                        ...
                        render: function (data, type, row) {
                            return `
                                    <div class="salary-payment-type">
                                        <div class="salary-payment-text section_sub_title">${row.salary_payment_type.charAt(0).toUpperCase()}
                                        <div class="tooltip-text">${row.salary_payment_type}</div></div>${row.salary_payment_type}
                                    </div>
                                `;
                        }
                    },
    ...
    $('#user_export').on('click', function (e) {
        e.preventDefault();
        var url = '{{ route('user_export') }}';
