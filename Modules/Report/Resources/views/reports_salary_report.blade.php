            ...
            <div class="breadcrumbs-area clearfix">
                <div class="breadcrumbs-sub">
                    ...
                    <a class="back_button"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <h4 class="page-title pull-left proxima_nova_semibold">Salary Report
                        </h4>
                    </div>
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li class="section_sub_title">/ Salary Report</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="main-content-inner on-time-main main-atten">
    ...
    <row>
        <div class="approve-datas atten-datas report-main-list attendance_reports_table_top report_salary_report">
            <div class="atten-data-search assign-data-search report_data col-md-6">
                <p class="proxima_nova_semibold holiday-staff-list-day">Total Staffs
                    <span class="holiday-spanolicy-count proxima_nova_bold">({{$staff_count}})</span>
                </p>
                <form action="" method="">
            ...
            <div class="approve-right-data report_atten_right_data col-md-6">
                ...
                <div class="approve-data-download dropdown-toggle proxima_nova_bold report_data_download">
                    <!-- <a href="#"> <img src="{{ asset('assets/admin/images/approve_punches/download-report.svg')}}"
                            ...
                            <div class="export_report_data">
                                <p class="export_data_report section_sub_title">Export</p></div>
                            <div class="report_down_img"> <img class=""
                                            src="{{ asset('assets/admin/images/approve_punches/download-report.svg')}}" alt="">
                            </div>
                    </a>
                ...
                <!-- <div class="dropdown-menu" x-placement="bottom-start">
                    <a class="dropdown-item proxima_nova_semibold" href="#" id="salary_export">Excel Report</a>
    ...
    <div class="approve_staff_data salary_report_table">
...
<script>
    ...
    $('#salary_export').on('click', function (e) {
        e.preventDefault();
        var url = '{{ route('salary_export') }}';
